...
router.get("/shoes", authenticate, function (req, res) {
    var products = fetch(`https://februarytest.herokuapp.com//products`)
...
router.get("/shoes/mens", authenticate, function (req, res) {
    var products = fetch(`https://februarytest.herokuapp.com//products2`)
        .then(function (products) {
            return products.json();
        })
        .then(function (products) {
...
router.get("/shoes/women", authenticate, function (req, res) {
    var products = fetch(`https://februarytest.herokuapp.com//products3`)
        .then(function (products) {
            return products.json();
        })
        .then(function (products) {
...
router.get("/shoes/kids", authenticate, function (req, res) {
    var products = fetch(`https://februarytest.herokuapp.com//products4`)
        .then(function (products) {
            return products.json();
        })
        .then(function (products) {
